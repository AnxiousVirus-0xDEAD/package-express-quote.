...
public class PackageExpress
{
    public static void Main(string[] args)
    {
        ...
        // Loop until valid numeric input is provided for weight
        ...
        if (weight > 50)
        {
            ...
            Console.ReadLine(); // Keep console open to view message
        ...
        // Loop until valid numeric input is provided for width
        ...
        // Loop until valid numeric input is provided for height
        ...
        // Loop until valid numeric input is provided for length
